...
public:	
	 ...
	 **/
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement", meta = (ClampMin = 0.0f))
	float MaxSpeed;
	...
	/**
	 * How quickly the player's velocity approaches their desired velocity (in units/s2),
	 * if the control stick is being pushed in any direction.
	 * Setting this to a different value than BreakingFriction will cause the player to slide
	 * along the floor more when changing direction than when stopping.
	 **/
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement", meta = (ClampMin = 0.0f))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement|Rotation", meta = (ClampMin = 0.0f))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement|Planar", meta = (ClampMin = 0.0f, ClampMax = 90.0f))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement|Deflections", meta = (ClampMin = 0.0f))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movement|Recovery", meta = (ClampMin = 0.0f))
